...
export interface InitOutput {
    ...
    readonly __wbg_singlerangeproof_free: (a: number, b: number) => void;
    ...
    readonly singlerangeproof_comm: (a: number) => [number, number];
    readonly singlerangeproof_proof: (a: number) => [number, number];
